...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        locationRecyclerView = (RecyclerView) this.findViewById(R.id.all_guests_list_view);

        locationRecyclerView.setLayoutManager(new LinearLayoutManager(this));

       AlarmClockDbConnection dbHelper = new AlarmClockDbConnection(this);

        mAddButton = (FloatingActionButton) this.findViewById(R.id.floatingActionButton);
        ...
        mAddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Class destinationActivity = AddActivity.class;
        ...
        mFusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        mAdapter.setWeatherData(location);
